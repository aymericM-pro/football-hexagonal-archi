...
import com.app.footballapispring.footballApi.rest.fixture.FixtureDTO;
import com.app.footballapispring.footballApi.rest.fixture.FixtureMapper;
...
import com.app.footballapispring.footballApi.rest.standing.StandingDTO;
import com.app.footballapispring.footballApi.rest.standing.StandingMapper;
import com.app.footballapispring.footballApi.rest.teams.TeamDetailDTO;
import com.app.footballapispring.footballApi.rest.teams.TeamDetailMapper;

import com.app.footballapispring.core.mediator.Mediator;
import com.app.footballapispring.footballApi.domain.fixtures.GetFixturesQuery;
import com.app.footballapispring.domain.player.GetPlayersQuery;
import com.app.footballapispring.footballApi.domain.standings.GetStandingsQuery;
import com.app.footballapispring.domain.teams.GetTeamDetailsQuery;
